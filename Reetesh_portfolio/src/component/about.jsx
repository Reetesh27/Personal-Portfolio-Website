...
const About = () => {
  return (
    <section
      id="about"
      className="min-h-screen bg-black text-white flex-col flex items-center justify-center px-6 py-16"
    > 
      <Slidein direction="up">
        <div className="max-w-5xl text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-10 text-[#76e3b5]">
            About Me
          </h2>
      ...
      <Slidein direction="up">
        <a
          href="/resume.pdf"
          download="Reetesh_Kumar_Resume.pdf" // file will download with this name
          className="mt-10 inline-flex items-center px-6 py-2 rounded-lg bg-black text-green-400 hover:bg-green-400 hover:text-black transition-all"
        >
          📄 Download Resume
        </a>
      </Slidein>
