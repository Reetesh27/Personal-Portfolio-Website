...
export default function Footer() {
  return (
    <footer className="bg-black text-gray-300 py-10 px-6 ">
      <div className="max-w-6xl mx-auto md:grid-cols-3 gap-8 justify-between flex">
        {/* Branding */}
        <div>
        ...
        <div className="left_foot flex gap-50 mr-30">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/Reetesh27" target="_blank" rel="noreferrer" 
                className="p-2 bg-gray-800 rounded-full hover:bg-green-500 transition">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com/in/reetesh-kumar-719463328 " target="_blank" rel="noreferrer"
                className="p-2 bg-gray-800 rounded-full hover:bg-green-500 transition">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/reetesh_mr27?igsh=YzljYTk1ODg3Zg== " target="_blank" rel="noreferrer"
                className="p-2 bg-gray-800 rounded-full hover:bg-green-500 transition">
